    ...
    return (
        <Dialog>
            <DialogTrigger asChild className="bg-black">
                <Button variant="default" className="pl-2 bg-black border-0 w-full h-12 hover:bg-[#333333]">
            ...
            <DialogContent className="sm:max-w-[425px] text-white bg-black border-slate-800/40">
                <DialogHeader>
                    <DialogTitle className="flex w-full justify-center items-center pb-4 border-b border-b-slate-800">Report
                        a problem</DialogTitle>
                </DialogHeader>
                <div className="pt-4">
                    ...
                    <p className="pt-4 text-sm text-muted-foreground">Your Instagram username and browser information
                        will be automatically included in your report.</p>
                </div>
