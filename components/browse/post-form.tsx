                ...
                <FormField control={form.control}
                           ...
                           render={({field}) => (
                               <FormItem>
                                   ...
                                   <FormControl>
                                       <Textarea
                                           className="h-36 bg-[#1f1f1f] rounded-xl border-none focus-visible:ring-1 focus-visible:ring-offset-1 ring-offset-light-3" {...field}/>
                                   </FormControl>
                ...
                <FormField control={form.control}
                           ...
                           render={({field}) => (
                               <FormItem>
                                   ...
                                   <FormControl>
                                       <FileUploader fieldChange={field.onChange} mediaUrl="" height="h-[612px]"/>
                                   </FormControl>
                                   <FormMessage className="text-red-500"/>
                               </FormItem>
                           )}
